                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-7 text-center">
                                ...
                                <h1 class="display-1 text-dark mb-4 animated zoomIn">Organic & Quality Tea
                                    Production</h1>
                                <a href="" class="btn btn-light rounded-pill py-3 px-5 animated zoomIn">Buy as
                                    Singles</a>
                                <a href="" class="btn btn-light rounded-pill py-3 px-5 animated zoomIn">Buy as
                                    Bulk</a>
                            </div>
    ...
    <div class="container py-5">
        ...
        <div class="owl-carousel product-carousel wow fadeInUp" data-wow-delay="0.5s">
            ...
            <a href="" class="d-block product-item rounded">
                <img src="{{asset('storage/'.$catas->image)}}" alt="{{$catas->name}}">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="store-item position-relative text-center">
                    <img class="img-fluid" src="{{asset('storage/'.$prods->image)}}" alt="{{$prods->name}}">
                    <!-- Discount overlay -->
