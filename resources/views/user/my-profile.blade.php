    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <strong>Address:</strong> {{$info->address}}, {{$info->distric}}
                        </div>
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    // If profile picture is set, display it
                        ...
                        var firstName = "{{$info->name}}"; // Replace with the actual first name
            ...
            <div class="col-12 text-center">
                <a href="{{route('account_settings',['id'=>$info->id])}}" class="btn btn-primary">Edit</a>
            </div>
        </div>
    </div>
</div>
