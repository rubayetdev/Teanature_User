...
{{--                            <a href="{{route('features',['id'=>$info->id])}}" class="dropdown-item">Features</a>--}}
                            ...
                            <a href="{{route('Listblog',['id'=>$info->id])}}" class="dropdown-item active">Blog Article</a>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <a href="{{route('blogs',['blog'=>$blog->id,'id'=>$info->id])}}" class="text-uppercase">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
