...
<marquee behavior="scroll" direction="left" style="font-family: Space Grotesk, sans-serif;">Sheikh
</marquee>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto">
                    ...
                    <a href="{{route('depo-welcome',['id'=>$info->id])}}" class="nav-item nav-link active">Home</a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7 text-center">
                                ...
                                <h1 class="display-1 text-dark mb-4 animated zoomIn">Organic & Quality Tea
                                    Production</h1>
                                <a href="{{route('depo-stores',['id'=>$info->id])}}"
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-7 text-center">
                                ...
                                <h1 class="display-1 text-dark mb-4 animated zoomIn">Organic & Quality Tea
                                    Production</h1>
                                <a href="{{route('depo-stores',['id'=>$info->id])}}" class="btn btn-light rounded-pill py-3 px-5 animated zoomIn">Buy as
                                    Bulk</a>
                            </div>
                        </div>
                    </div>
