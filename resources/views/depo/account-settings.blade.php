...
<!-- Navbar Start -->
<marquee behavior="scroll" direction="left">Sheikh</marquee>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <!-- User Information Form -->
                        <form action="{{route('upload-depo-data')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="ownername" value="{{$info->owner_name}}">
                            </div>
                            <!-- Email Input -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" value="{{$info->mobile}}">
                            </div>
                            <!-- Address Input -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="address" name="city" value="{{$info->city}}">
                            </div>
            ...
            <div class="row">
                <div class="col-md-8 md-6">
                    <div class="text-end">
                        <a href="{{ route('depo-my_profile', ['id' => $info->id]) }}" class="btn btn-secondary me-2">Back</a>
