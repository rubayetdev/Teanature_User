...
<body>
    ...
    <!-- Navbar Start -->
    <marquee behavior="scroll" direction="left" style="font-family: Space Grotesk, sans-serif;">Welcome To Official
        website Of “ TeanaturE Limited ”</marquee>
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="{{route('depo-product',['id'=>$info->id])}}" class="nav-item nav-link active">Products</a>
